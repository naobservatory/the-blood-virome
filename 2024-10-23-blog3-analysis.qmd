...
formatted_datasets <- c("Cebria-Mendoza et al. (2021)", "Thijssen et al. (2023)", "Mengyi et al. (2023)", "Aydillo et al. (2022)","O'Connell (2024)", "Thompson et al. (2023)")
...
g_all_dot <- ggplot(read_counts, aes(x=dataset, y=p_reads+1e-10, fill = sample_type)) +
...
g_hv_family <-  ggplot(mapping=aes(x=dataset, y=p_reads, fill=classification)) +
  ...
  theme(
    ...
    coord_flip()
g_hv_family
ggsave(file.path(out_dir, "final/all_family_composition.png"), g_hv_family, width = 20, height = 10)
```
