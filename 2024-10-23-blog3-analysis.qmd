...
g_all_dot
ggsave(file.path(out_dir, "final/ra_hv_reads_dot.png"), g_all_dot, width = 12.5, height = 5.5)
...
joint_plot
ggsave(file.path(out_dir, "final/prevelance_ra_family_barplot.png"), joint_plot, width = 13, height = 8.5)
```
...
joint_plot <- ggarrange(g_virus_prevalence + theme(legend.position = "none"), g_hv_genus + theme(axis.text.y=element_blank()), 
                        ...
                        widths = c(1, 1.25))  # Adjust the widths to make the first plot wider
joint_plot
ggsave(file.path(out_dir, "final/prevelance_ra_genus_w_family_barplot.png"), joint_plot, width = 13, height = 18)
